...
summary(fit2)
```
Статическая значимость переменной consonansts сохраняется. С добавлением area изменилось значение p-value. Линии параллельны со смещением.
...
summary(fit3)
```
p-value увеличилось, consonants значим. У линий изменился угол наклона, и теперь они направлены в разные стороны.
...
Переменная consonants значима, знаение p-value стало ниже. На графике у линий изменился наклон и смещение. Возможно, разница зависит от того, как действует случайный эффект. 
